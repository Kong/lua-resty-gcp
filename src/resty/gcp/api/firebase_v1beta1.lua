  ...
  ["schemas"] = {
    ...
    ["FirebaseProject"] = {
      ...
      ["properties"] = {
        ["annotations"] = {
          ...
          ["description"] = "Set of user-defined annotations for the FirebaseProject as per [AIP-128](https://google.aip.dev/128#annotations). These annotations are intended solely for developers and client-side tools Firebase services will not mutate this annotation set.",
          ["type"] = "object",
        },
        ["displayName"] = {
        ...
        ["etag"] = {
          ["description"] = "This checksum is computed by the server based on the value of other fields, and may be sent on update requests to ensure the client has an up-to-date value before proceeding. [AIP-154](https://google.aip.dev/154#declarative-friendly-resources). This etag is strongly validated.",
          ["type"] = "string",
        },
        ["name"] = {
          ["description"] = "The resource name of the Project, in the format: projects/PROJECT_IDENTIFIER PROJECT_IDENTIFIER: the Project's [`ProjectNumber`](../projects#FirebaseProject.FIELDS.project_number) ***(recommended)*** or its [`ProjectId`](../projects#FirebaseProject.FIELDS.project_id). Learn more about using project identifiers in Google's [AIP 2510 standard](https://google.aip.dev/cloud/2510). Note that the value for PROJECT_IDENTIFIER in any response body will be the `ProjectId`.",
        ...
        ["projectId"] = {
          ["description"] = "Output only. A user-assigned unique identifier for the Project. This identifier may appear in URLs or names for some Firebase resources associated with the Project, but it should generally be treated as a convenience alias to reference the Project.",
          ["readOnly"] = true,
          ["type"] = "string",
        },
        ["projectNumber"] = {
          ["description"] = "Output only. The globally unique, Google-assigned canonical identifier for the Project. Use this identifier when configuring integrations and/or making API calls to Firebase or third-party services.",
          ["format"] = "int64",
          ["readOnly"] = true,
          ["type"] = "string",
        },
    ...
    ["RemoveAndroidAppRequest"] = {
      ...
      ["properties"] = {
        ...
        ["validateOnly"] = {
          ["description"] = "If set to true, only validate the request and do not delete the app.",
          ["type"] = "boolean",
        },
      },
      ["type"] = "object",
