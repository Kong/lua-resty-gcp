return {
  ...
  schemas = {
    ...
    AuditableService = {
      ...
      properties = {
        name = {
          description = "Public name of the service. For example, the service name for IAM is 'iam.googleapis.com'.",
          type = "string",
        },
      },
      type = "object",
    ...
    ExtendedStatus = {
      description = "Extended status can store additional metadata. For example, for keys disabled due to their private key data being expoesed we may include a message with more information about the exposure.",
      id = "ExtendedStatus",
      properties = {
        key = {
    ...
    GoogleIamAdminV1WorkforcePoolProviderExtraAttributesOAuth2Client = {
      ...
      properties = {
        attributesType = {
          description = "Required. Represents the IdP and type of claims that should be fetched.",
          enum = {
        ...
        clientSecret = {
          ...
          description = "Required. The OAuth 2.0 client secret for retrieving extra attributes from the identity provider. Required to get the Access Token using client credentials grant flow.",
        },
        issuerUri = {
        ...
        queryParameters = {
          ["$ref"] = "GoogleIamAdminV1WorkforcePoolProviderExtraAttributesOAuth2ClientQueryParameters",
          description = "Optional. Represents the parameters to control which claims are fetched from an IdP.",
        },
      },
      type = "object",
    },
    GoogleIamAdminV1WorkforcePoolProviderExtraAttributesOAuth2ClientQueryParameters = {
      ...
      id = "GoogleIamAdminV1WorkforcePoolProviderExtraAttributesOAuth2ClientQueryParameters",
      properties = {
        filter = {
    ...
    ListOauthClientCredentialsResponse = {
      ...
      properties = {
        oauthClientCredentials = {
          description = "A list of oauth client credentials.",
          items = {
            ["$ref"] = "OauthClientCredential",
          },
          type = "array",
    ...
    OauthClient = {
      description = "Represents an oauth client. Used to access Google Cloud resources on behave of a user by using OAuth2 Protocol to obtain an access token from Google Cloud Platform.",
      id = "OauthClient",
      properties = {
        allowedGrantTypes = {
          description = "Required. The list of OAuth grant type is allowed for the oauth client.",
          items = {
            enum = {
        ...
        clientId = {
          description = "Output only. The system-generated oauth client id.",
          readOnly = true,
          type = "string",
        },
        clientType = {
          description = "Immutable. The type of oauth client. either public or private.",
          enum = {
        ...
        description = {
          description = "Optional. A user-specified description of the oauth client. Cannot exceed 256 characters.",
          type = "string",
        },
        disabled = {
          description = "Optional. Whether the oauth client is disabled. You cannot use a disabled oauth client for login.",
          type = "boolean",
        },
        displayName = {
          description = "Optional. A user-specified display name of the oauth client. Cannot exceed 32 characters.",
          type = "string",
        },
        expireTime = {
          description = "Output only. Time after which the oauth client will be permanently purged and cannot be recovered.",
          format = "google-datetime",
          readOnly = true,
          type = "string",
        },
        ...
        state = {
          description = "Output only. The state of the oauth client.",
          enum = {
            "STATE_UNSPECIFIED",
            "ACTIVE",
            "DELETED",
    ...
    OauthClientCredential = {
      description = "Represents an oauth client credential. Used to authenticate an oauth client while accessing Google Cloud resources on behalf of a user by using OAuth2 Protocol.",
      id = "OauthClientCredential",
      properties = {
        clientSecret = {
          description = "Output only. The system-generated oauth client secret.",
          readOnly = true,
          type = "string",
        },
        disabled = {
          description = "Optional. Whether the oauth client credential is disabled. You cannot use a disabled oauth client credential for OAuth.",
          type = "boolean",
        },
        displayName = {
          description = "Optional. A user-specified display name of the oauth client credential Cannot exceed 32 characters.",
          type = "string",
        },
        name = {
          description = "Immutable. The resource name of the oauth client credential. Format: `projects/{project}/locations/{location}/oauthClients/{oauth_client}/credentials/{credential}`",
