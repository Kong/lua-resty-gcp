    ...
    ["TrainingRun"] = {
      ...
      ["properties"] = {
        ["classLevelGlobalExplanations"] = {
          ["description"] = "Global explanation contains the explanation of top features on the class level. Applies to classification models only.",
          ["items"] = {
        ...
        ["modelLevelGlobalExplanation"] = {
          ["$ref"] = "GlobalExplanation",
          ["description"] = "Global explanation contains the explanation of top features on the model level. Applies to both regression and classification models.",
        },
        ["results"] = {
        ...
        ["vertexAiModelVersion"] = {
          ["description"] = "The model version in Vertex AI Model Registry for this training run",
          ["type"] = "string",
        },
      },
      ["type"] = "object",
