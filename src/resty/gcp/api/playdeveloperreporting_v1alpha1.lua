return {
  ...
  ["schemas"] = {
    ["GooglePlayDeveloperReportingV1alpha1Anomaly"] = {
      ...
      ["properties"] = {
        ["dimensions"] = {
          ...
          ["items"] = {
            ["$ref"] = "GooglePlayDeveloperReportingV1alpha1DimensionValue",
          },
          ["type"] = "array",
        },
        ["metric"] = {
          ["$ref"] = "GooglePlayDeveloperReportingV1alpha1MetricValue",
    ...
    ["GooglePlayDeveloperReportingV1alpha1FreshnessInfo"] = {
      ...
      ["properties"] = {
        ["freshnesses"] = {
          ...
          ["items"] = {
            ["$ref"] = "GooglePlayDeveloperReportingV1alpha1FreshnessInfoFreshness",
          },
          ["type"] = "array",
        },
      },
    ...
    ["GooglePlayDeveloperReportingV1alpha1ListAnomaliesResponse"] = {
      ...
      ["properties"] = {
        ["anomalies"] = {
          ...
          ["items"] = {
            ["$ref"] = "GooglePlayDeveloperReportingV1alpha1Anomaly",
          },
          ["type"] = "array",
        },
        ["nextPageToken"] = {
    ...
    ["GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest"] = {
      ...
      ["id"] = "GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetRequest",
      ["properties"] = {
        ["dimensions"] = {
          ["description"] = "Dimensions to slice the data by. **Supported dimensions:** * `apiLevel` (string): the API level of Android that was running on the user's device. * `versionCode` (int64): version of the app that was running on the user's device. * `deviceModel` (string): unique identifier of the user's device model. * `deviceType` (string): the type (also known as form factor) of the user's device. * `countryCode` (string): the country or region of the user's device based on their IP address, represented as a 2-letter ISO-3166 code (e.g. US for the United States). * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (3GB, 4GB, etc.). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung. [Reference](https://developer.android.com/reference/android/os/Build#SOC_MANUFACTURER) * `deviceSocModel` (string): Model of the device's primary system-on-chip, e.g., \"Exynos 2100\". [Reference](https://developer.android.com/reference/android/os/Build#SOC_MODEL) * `deviceCpuMake` (string): Make of the device's CPU, e.g., Qualcomm. * `deviceCpuModel` (string): Model of the device's CPU, e.g., \"Kryo 240\". * `deviceGpuMake` (string): Make of the device's GPU, e.g., ARM. * `deviceGpuModel` (string): Model of the device's GPU, e.g., Mali. * `deviceGpuVersion` (string): Version of the device's GPU, e.g., T750. * `deviceVulkanVersion` (string): Vulkan version of the device, e.g., \"4198400\". * `deviceGlEsVersion` (string): OpenGL ES version of the device, e.g., \"196610\". * `deviceScreenSize` (string): Screen size of the device, e.g., NORMAL, LARGE. * `deviceScreenDpi` (string): Screen density of the device, e.g., mdpi, hdpi.",
          ["items"] = {
    ...
    ["GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse"] = {
      ...
      ["id"] = "GooglePlayDeveloperReportingV1alpha1QueryExcessiveWakeupRateMetricSetResponse",
      ["properties"] = {
        ["nextPageToken"] = {
          ["description"] = "Continuation token to fetch the next page of data.",
          ["type"] = "string",
    ...
    ["GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetRequest"] = {
      ...
      ["id"] = "GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetRequest",
      ["properties"] = {
        ["dimensions"] = {
          ["description"] = "Dimensions to slice the data by. **Supported dimensions:** * `apiLevel` (string): the API level of Android that was running on the user's device. * `versionCode` (int64): version of the app that was running on the user's device. * `deviceModel` (string): unique identifier of the user's device model. * `deviceType` (string): the type (also known as form factor) of the user's device. * `countryCode` (string): the country or region of the user's device based on their IP address, represented as a 2-letter ISO-3166 code (e.g. US for the United States). * `deviceRamBucket` (int64): RAM of the device, in MB, in buckets (3GB, 4GB, etc.). * `deviceSocMake` (string): Make of the device's primary system-on-chip, e.g., Samsung. [Reference](https://developer.android.com/reference/android/os/Build#SOC_MANUFACTURER) * `deviceSocModel` (string): Model of the device's primary system-on-chip, e.g., \"Exynos 2100\". [Reference](https://developer.android.com/reference/android/os/Build#SOC_MODEL) * `deviceCpuMake` (string): Make of the device's CPU, e.g., Qualcomm. * `deviceCpuModel` (string): Model of the device's CPU, e.g., \"Kryo 240\". * `deviceGpuMake` (string): Make of the device's GPU, e.g., ARM. * `deviceGpuModel` (string): Model of the device's GPU, e.g., Mali. * `deviceGpuVersion` (string): Version of the device's GPU, e.g., T750. * `deviceVulkanVersion` (string): Vulkan version of the device, e.g., \"4198400\". * `deviceGlEsVersion` (string): OpenGL ES version of the device, e.g., \"196610\". * `deviceScreenSize` (string): Screen size of the device, e.g., NORMAL, LARGE. * `deviceScreenDpi` (string): Screen density of the device, e.g., mdpi, hdpi.",
          ["items"] = {
    ...
    ["GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse"] = {
      ...
      ["id"] = "GooglePlayDeveloperReportingV1alpha1QueryStuckBackgroundWakelockRateMetricSetResponse",
      ["properties"] = {
        ["nextPageToken"] = {
          ["description"] = "Continuation token to fetch the next page of data.",
          ["type"] = "string",
    ...
    ["GooglePlayDeveloperReportingV1alpha1SearchErrorIssuesResponse"] = {
      ...
      ["properties"] = {
        ["errorIssues"] = {
          ...
          ["items"] = {
            ["$ref"] = "GooglePlayDeveloperReportingV1alpha1ErrorIssue",
          },
          ["type"] = "array",
        },
        ["nextPageToken"] = {
    ...
    ["GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse"] = {
      ["description"] = "Response with a paginated list of error reports matching the search query.",
      ["id"] = "GooglePlayDeveloperReportingV1alpha1SearchErrorReportsResponse",
      ["properties"] = {
        ["errorReports"] = {
          ["description"] = "Error reports that were found.",
          ["items"] = {
            ["$ref"] = "GooglePlayDeveloperReportingV1alpha1ErrorReport",
          },
          ["type"] = "array",
        },
        ["nextPageToken"] = {
