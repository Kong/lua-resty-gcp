return {
  ...
  schemas = {
    ...
    DataResidencyAugmentedView = {
      ...
      id = "DataResidencyAugmentedView",
      properties = {
        crGopoGuris = {
          description = "Cloud resource to Google owned production object mapping in the form of GURIs. The GURIs should be available in DG KB storage/cns tables. This is the preferred way of providing cloud resource mappings. For further details please read go/cloud-resource-monitoring_sig",
          items = {
            type = "string",
          },
          type = "array",
        ...
        serviceData = {
          ["$ref"] = "ServiceData",
          description = "Service-specific data. Only required for pre-determined services. Generally used to bind a Cloud Resource to some a TI container that uniquely specifies a customer. See milestone 2 of DRZ KR8 SIG for more information.",
        },
        tpIds = {
          description = "The list of project_id's of the tenant projects in the 'google.com' org which serve the Cloud Resource. See go/drz-mst-sig for more details.",
          items = {
            type = "string",
          },
          type = "array",
    ...
    NetworkConfig = {
      ...
      properties = {
        ...
        privateServiceConnectConfig = {
          ["$ref"] = "PrivateServiceConnectConfig",
    ...
    PersistentDiskData = {
      ...
      properties = {
        ...
        gcsBucketNames = {
          description = "The GCS Buckets that back this snapshot or image. This is required as `cr_ti_prefixes` and `cr_ti_guris` only accept TI resources. This should be the globally unique bucket name.",
          items = {
            type = "string",
          },
          type = "array",
    ...
    PrivateServiceConnectConfig = {
      ...
      id = "PrivateServiceConnectConfig",
      properties = {
    ...
    ServiceData = {
      description = "This message defines service-specific data that certain service teams must provide as part of the Data Residency Augmented View for a resource. Next ID: 2",
      id = "ServiceData",
      properties = {
        pd = {
          ["$ref"] = "PersistentDiskData",
          description = "Auxiliary data for the persistent disk pipeline provided to provide the LSV Colossus Roots and GCS Buckets.",
        },
      },
      type = "object",
    },
