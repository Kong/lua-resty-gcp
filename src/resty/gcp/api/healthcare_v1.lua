                ...
                fhirStores = {
                  methods = {
                    ...
                    rollback = {
                      ...
                      flatPath = "v1/projects/{projectsId}/locations/{locationsId}/datasets/{datasetsId}/fhirStores/{fhirStoresId}:rollback",
                      httpMethod = "POST",
  ...
  schemas = {
    ...
    DicomStore = {
      ...
      properties = {
        ...
        streamConfigs = {
          ...
          items = {
            ["$ref"] = "GoogleCloudHealthcareV1DicomStreamConfig",
          },
          type = "array",
        },
      },
    ...
    RollbackFhirResourcesRequest = {
      ...
      properties = {
        ...
        filteringFields = {
          ["$ref"] = "RollbackFhirResourceFilteringFields",
