return {
  ...
  ["schemas"] = {
    ...
    ["SecurityCenterProperties"] = {
      ...
      ["properties"] = {
        ["resourceName"] = {
          ["description"] = "Immutable. The full resource name of the Google Cloud resource this asset represents. This field is immutable after create time. See: https://cloud.google.com/apis/design/resource_names#full_resource_name",
          ["type"] = "string",
        },
        ["resourceOwners"] = {
