  ...
  ["schemas"] = {
    ["Backup"] = {
      ...
      ["properties"] = {
        ...
        ["downloadBytes"] = {
          ["description"] = "Output only. Amount of bytes that will be downloaded if the backup is restored",
          ["format"] = "int64",
          ["readOnly"] = true,
          ["type"] = "string",
        },
    ...
    ["Share"] = {
      ["description"] = "A Cloud Filestore share.",
      ["id"] = "Share",
      ["properties"] = {
        ["capacityGb"] = {
          ["description"] = "File share capacity in gigabytes (GB). Cloud Filestore defines 1 GB as 1024^3 bytes. Must be greater than 0.",
          ["format"] = "int64",
          ["type"] = "string",
        },
        ["createTime"] = {
