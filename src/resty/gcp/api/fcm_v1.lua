    ...
    ["ApnsConfig"] = {
      ...
      ["properties"] = {
        ...
        ["headers"] = {
          ...
          ["description"] = "HTTP request headers defined in Apple Push Notification Service. Refer to [APNs request headers](https://developer.apple.com/documentation/usernotifications/setting_up_a_remote_notification_server/sending_notification_requests_to_apns) for supported headers such as `apns-expiration` and `apns-priority`.",
          ["type"] = "object",
        },
        ["payload"] = {
          ["additionalProperties"] = {
