return {
  ...
  schemas = {
    ...
    DnsZonePair = {
      description = "* Represents a pair of private and peering DNS zone resources. *",
      id = "DnsZonePair",
      properties = {
        consumerPeeringZone = {
          ["$ref"] = "DnsZone",
          description = "The DNS peering zone in the consumer project.",
        },
        producerPrivateZone = {
          ["$ref"] = "DnsZone",
    ...
    ListDnsRecordSetsResponse = {
      description = "Represents all DNS RecordSets associated with the producer network",
      id = "ListDnsRecordSetsResponse",
      properties = {
        dnsRecordSets = {
          description = "DNS record Set Resource",
          items = {
            ["$ref"] = "DnsRecordSet",
          },
          type = "array",
    ...
    ListDnsZonesResponse = {
      description = "Represents all DNS zones in the shared producer host project and the matching peering zones in the consumer project.",
      id = "ListDnsZonesResponse",
      properties = {
        dnsZonePairs = {
          description = "All pairs of private DNS zones in the shared producer host project and the matching peering zones in the consumer project..",
          items = {
            ["$ref"] = "DnsZonePair",
          },
          type = "array",
