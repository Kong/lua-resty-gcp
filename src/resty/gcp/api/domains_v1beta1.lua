  ...
  ["schemas"] = {
      ...
      ["properties"] = {
        ...
        ["resourceState"] = {
          ...
          ["enumDescriptions"] = {
            ...
            "A `Registration` resource cannot be created for this domain because it is deleted, but can be restored with Google Domains.",
          },
          ["type"] = "string",
        },
        ["yearlyPrice"] = {
    ...
    ["TransferParameters"] = {
      ...
      ["properties"] = {
        ...
        ["currentRegistrarUri"] = {
          ["description"] = "The URL of registrar that currently manages the domain.",
          ["type"] = "string",
        },
        ["domainName"] = {
          ["description"] = "The domain name. Unicode domain names are expressed in Punycode format.",
