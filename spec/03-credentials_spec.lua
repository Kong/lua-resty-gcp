...
describe("access token", function ()
  ...
  local function create_http_mock(responses, captured_requests)
    return {
      new = function()
        return {
          counter = 0,
          close = function() return true end,
          set_proxy_options = function(self, proxy_opts)
  ...
  local function with_http_mock(mock_responses, test_function)
    ...
    package.loaded["resty.luasocket.http"] = create_http_mock(mock_responses, captured_requests)
    ...
    test_function(temp_access_token, captured_requests)
  ...
  local function with_gcp_http_mock(mock_responses, test_function)
    local original_http = package.loaded["resty.luasocket.http"]
    ...
    test_function(temp_gcp, captured_requests)
