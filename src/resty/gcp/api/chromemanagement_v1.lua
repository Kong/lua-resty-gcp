return {
  ...
  schemas = {
    ...
    GoogleChromeManagementV1TelemetryEvent = {
      ...
      properties = {
        ...
        networkConnectionStateChangeEvent = {
          ...
          description = "Output only. Payload for network connection state change event. Present only when `event_type` is `NETWORK_CONNECTION_STATE_CHANGE`.",
          readOnly = true,
        },
        reportTime = {
    ...
    GoogleChromeManagementV1TelemetryNetworkConnectionStateChangeEvent = {
      description = "`TelemetryNetworkConnectionStateChangeEvent` is triggered on network connection state changes.",
