return {
  ...
  ["schemas"] = {
    ...
    ["GoogleChromePolicyV1BatchDeleteGroupPoliciesRequest"] = {
      ...
      ["id"] = "GoogleChromePolicyV1BatchDeleteGroupPoliciesRequest",
      ["properties"] = {
        ["requests"] = {
          ...
          ["items"] = {
            ["$ref"] = "GoogleChromePolicyV1DeleteGroupPolicyRequest",
          },
          ["type"] = "array",
        },
      },
    ...
    ["GoogleChromePolicyV1BatchModifyGroupPoliciesRequest"] = {
      ...
      ["id"] = "GoogleChromePolicyV1BatchModifyGroupPoliciesRequest",
      ["properties"] = {
        ["requests"] = {
          ...
          ["items"] = {
            ["$ref"] = "GoogleChromePolicyV1ModifyGroupPolicyRequest",
          },
          ["type"] = "array",
        },
      },
    ...
    ["GoogleChromePolicyV1DeleteGroupPolicyRequest"] = {
      ...
      ["id"] = "GoogleChromePolicyV1DeleteGroupPolicyRequest",
      ["properties"] = {
        ["policySchema"] = {
    ...
    ["GoogleChromePolicyV1ListGroupPriorityOrderingRequest"] = {
      ...
      ["id"] = "GoogleChromePolicyV1ListGroupPriorityOrderingRequest",
      ["properties"] = {
        ["policyNamespace"] = {
    ...
    ["GoogleChromePolicyV1ListGroupPriorityOrderingResponse"] = {
      ...
      ["id"] = "GoogleChromePolicyV1ListGroupPriorityOrderingResponse",
      ["properties"] = {
        ["groupIds"] = {
    ...
    ["GoogleChromePolicyV1ModifyGroupPolicyRequest"] = {
      ...
      ["id"] = "GoogleChromePolicyV1ModifyGroupPolicyRequest",
      ["properties"] = {
        ["policyTargetKey"] = {
          ["$ref"] = "GoogleChromePolicyV1PolicyTargetKey",
          ["description"] = "Required. The key of the target for which we want to modify a policy. The target resource must point to a Group.",
    ...
    ["GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest"] = {
      ...
      ["id"] = "GoogleChromePolicyV1UpdateGroupPriorityOrderingRequest",
      ["properties"] = {
        ["groupIds"] = {
