return {
  ...
  schemas = {
    ...
    GoogleAppsCardV1Column = {
      description = "A column. [Google Workspace Add-ons and Chat apps](https://developers.google.com/workspace/extend): Columns for Google Workspace Add-ons are in Developer Preview.",
    ...
    GoogleAppsCardV1Widgets = {
      description = "The supported widgets that you can include in a column. [Google Workspace Add-ons and Chat apps](https://developers.google.com/workspace/extend): Columns for Google Workspace Add-ons are in Developer Preview.",
