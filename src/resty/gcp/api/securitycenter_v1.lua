  ...
  schemas = {
    ...
    Finding = {
      ...
      properties = {
        ...
        vulnerability = {
          ["$ref"] = "Vulnerability",
          description = "Represents vulnerability-specific fields like CVE and CVS scores. CVE stands for Common Vulnerabilities and Exposures (https://cve.mitre.org/about/)",
        },
      },
      type = "object",
    },
