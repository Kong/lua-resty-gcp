return {
  ...
  ["schemas"] = {
    ...
    ["GoogleCloudApigeeV1KeyValueEntry"] = {
      ["description"] = "Key value map pair where the value represents the data associated with the corresponding key.",
    ...
    ["GoogleCloudApigeeV1ListKeyValueEntriesResponse"] = {
      ["description"] = "The request structure for listing Key value map keys and its corrresponding values.",
