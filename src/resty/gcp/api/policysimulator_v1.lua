  ...
  schemas = {
    ...
    GoogleCloudPolicysimulatorV1ListOrgPolicyViolationsResponse = {
      ...
      properties = {
        ...
        orgPolicyViolations = {
          ...
          items = {
            ["$ref"] = "GoogleCloudPolicysimulatorV1OrgPolicyViolation",
          },
          type = "array",
        },
      },
    ...
    GoogleCloudPolicysimulatorV1OrgPolicyOverlay = {
      ...
      properties = {
        customConstraints = {
          ...
          items = {
            ["$ref"] = "GoogleCloudPolicysimulatorV1OrgPolicyOverlayCustomConstraintOverlay",
          },
          type = "array",
        },
        policies = {
          ...
          items = {
            ["$ref"] = "GoogleCloudPolicysimulatorV1OrgPolicyOverlayPolicyOverlay",
          },
          type = "array",
        },
      },
    ...
    GoogleCloudPolicysimulatorV1OrgPolicyViolation = {
      ...
      properties = {
        ...
        resource = {
          ["$ref"] = "GoogleCloudPolicysimulatorV1ResourceContext",
    ...
    GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreview = {
      ...
      properties = {
        ...
        overlay = {
          ["$ref"] = "GoogleCloudPolicysimulatorV1OrgPolicyOverlay",
          description = "Required. The proposed changes we are previewing violations for.",
        },
        resourceCounts = {
          ["$ref"] = "GoogleCloudPolicysimulatorV1OrgPolicyViolationsPreviewResourceCounts",
