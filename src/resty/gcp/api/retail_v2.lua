return {
  ...
  schemas = {
    ...
    GoogleCloudRetailV2BigQueryOutputResult = {
      ...
      id = "GoogleCloudRetailV2BigQueryOutputResult",
      properties = {
        datasetId = {
    ...
    GoogleCloudRetailV2CatalogAttribute = {
      ...
      properties = {
        ...
        facetConfig = {
          ["$ref"] = "GoogleCloudRetailV2CatalogAttributeFacetConfig",
          description = "Contains facet options.",
        },
        inUse = {
    ...
    GoogleCloudRetailV2CatalogAttributeFacetConfig = {
      ...
      id = "GoogleCloudRetailV2CatalogAttributeFacetConfig",
      properties = {
        facetIntervals = {
        ...
        ignoredFacetValues = {
          ...
          items = {
            ["$ref"] = "GoogleCloudRetailV2CatalogAttributeFacetConfigIgnoredFacetValues",
          },
          type = "array",
        },
        mergedFacet = {
          ["$ref"] = "GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacet",
          description = "Use this field only if you want to merge a facet key into another facet key.",
        },
        mergedFacetValues = {
        ...
        rerankConfig = {
          ["$ref"] = "GoogleCloudRetailV2CatalogAttributeFacetConfigRerankConfig",
          description = "Set this field only if you want to rerank based on facet values engaged by the user for the current key. This option is only possible for custom facetable textual keys.",
        },
      },
      type = "object",
    },
    GoogleCloudRetailV2CatalogAttributeFacetConfigIgnoredFacetValues = {
      ...
      id = "GoogleCloudRetailV2CatalogAttributeFacetConfigIgnoredFacetValues",
      properties = {
        endTime = {
    ...
    GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacet = {
      ...
      id = "GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacet",
      properties = {
        mergedFacetKey = {
    ...
    GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacetValue = {
      ...
      id = "GoogleCloudRetailV2CatalogAttributeFacetConfigMergedFacetValue",
      properties = {
        mergedValue = {
    ...
    GoogleCloudRetailV2CatalogAttributeFacetConfigRerankConfig = {
      ...
      id = "GoogleCloudRetailV2CatalogAttributeFacetConfigRerankConfig",
      properties = {
        facetValues = {
    ...
    GoogleCloudRetailV2CompletionConfig = {
      ...
      properties = {
        ...
        lastSuggestionsImportOperation = {
          description = "Output only. Name of the LRO corresponding to the latest suggestion terms list import. Can use GetOperation API method to retrieve the latest state of the Long Running Operation.",
          readOnly = true,
          type = "string",
        },
        matchingOrder = {
    ...
    GoogleCloudRetailV2ExperimentInfoServingConfigExperiment = {
      description = "Metadata for active serving config A/B tests.",
      id = "GoogleCloudRetailV2ExperimentInfoServingConfigExperiment",
      properties = {
        experimentServingConfig = {
          description = "The fully qualified resource name of the serving config Experiment.VariantArm.serving_config_id responsible for generating the search response. For example: `projects/*/locations/*/catalogs/*/servingConfigs/*`.",
          type = "string",
        },
    ...
    GoogleCloudRetailV2ExportAnalyticsMetricsRequest = {
      ...
      id = "GoogleCloudRetailV2ExportAnalyticsMetricsRequest",
      properties = {
        filter = {
        ...
        outputConfig = {
          ["$ref"] = "GoogleCloudRetailV2OutputConfig",
    ...
    GoogleCloudRetailV2ExportAnalyticsMetricsResponse = {
      ...
      properties = {
        ...
        errorsConfig = {
          ["$ref"] = "GoogleCloudRetailV2ExportErrorsConfig",
          description = "This field is never set.",
        },
        outputResult = {
          ["$ref"] = "GoogleCloudRetailV2OutputResult",
    ...
    GoogleCloudRetailV2ExportErrorsConfig = {
      ...
      id = "GoogleCloudRetailV2ExportErrorsConfig",
      properties = {
        gcsPrefix = {
    ...
    GoogleCloudRetailV2ExportMetadata = {
      ...
      id = "GoogleCloudRetailV2ExportMetadata",
      properties = {
        createTime = {
    ...
    GoogleCloudRetailV2GcsOutputResult = {
      ...
      id = "GoogleCloudRetailV2GcsOutputResult",
      properties = {
        outputUri = {
    ...
    GoogleCloudRetailV2ImportProductsRequest = {
      ...
      properties = {
        ...
        updateMask = {
          description = "Indicates which fields in the provided imported `products` to update. If not set, all fields are updated. If provided, only the existing product fields are updated. Missing products will not be created.",
          format = "google-fieldmask",
          type = "string",
        },
      },
    ...
    GoogleCloudRetailV2Model = {
      ...
      properties = {
        ...
        modelFeaturesConfig = {
          ["$ref"] = "GoogleCloudRetailV2ModelModelFeaturesConfig",
        ...
        servingConfigLists = {
          ...
          items = {
            ["$ref"] = "GoogleCloudRetailV2ModelServingConfigList",
          },
          readOnly = true,
          type = "array",
        },
    ...
    GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfig = {
      ...
      id = "GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfig",
      properties = {
        contextProductsType = {
    ...
    GoogleCloudRetailV2ModelModelFeaturesConfig = {
      ...
      id = "GoogleCloudRetailV2ModelModelFeaturesConfig",
      properties = {
        frequentlyBoughtTogetherConfig = {
          ["$ref"] = "GoogleCloudRetailV2ModelFrequentlyBoughtTogetherFeaturesConfig",
    ...
    GoogleCloudRetailV2ModelServingConfigList = {
      ...
      id = "GoogleCloudRetailV2ModelServingConfigList",
      properties = {
        servingConfigIds = {
    ...
    GoogleCloudRetailV2OutputConfig = {
      ...
      id = "GoogleCloudRetailV2OutputConfig",
      properties = {
        bigqueryDestination = {
          ["$ref"] = "GoogleCloudRetailV2OutputConfigBigQueryDestination",
          description = "The BigQuery location where the output is to be written to.",
        },
        gcsDestination = {
          ["$ref"] = "GoogleCloudRetailV2OutputConfigGcsDestination",
    ...
    GoogleCloudRetailV2OutputConfigBigQueryDestination = {
      ...
      id = "GoogleCloudRetailV2OutputConfigBigQueryDestination",
      properties = {
        datasetId = {
    ...
    GoogleCloudRetailV2OutputConfigGcsDestination = {
      ...
      id = "GoogleCloudRetailV2OutputConfigGcsDestination",
      properties = {
        outputUriPrefix = {
    ...
    GoogleCloudRetailV2OutputResult = {
      ...
      properties = {
        bigqueryResult = {
          ...
          items = {
            ["$ref"] = "GoogleCloudRetailV2BigQueryOutputResult",
          },
          type = "array",
        },
        gcsResult = {
          ...
          items = {
            ["$ref"] = "GoogleCloudRetailV2GcsOutputResult",
          },
          type = "array",
        },
      },
    ...
    GoogleCloudRetailV2ResumeModelRequest = {
      ...
      id = "GoogleCloudRetailV2ResumeModelRequest",
      properties = {},
      type = "object",
    },
    GoogleCloudRetailV2Rule = {
      ...
      properties = {
        ...
        removeFacetAction = {
          ["$ref"] = "GoogleCloudRetailV2RuleRemoveFacetAction",
    ...
    GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment = {
      ...
      id = "GoogleCloudRetailV2RuleForceReturnFacetActionFacetPositionAdjustment",
      properties = {
        attributeName = {
    ...
    GoogleCloudRetailV2RuleRemoveFacetAction = {
      ...
      id = "GoogleCloudRetailV2RuleRemoveFacetAction",
      properties = {
        attributeNames = {
    ...
    GoogleCloudRetailV2SearchResponse = {
      ...
      properties = {
        ...
        experimentInfo = {
          ...
          items = {
            ["$ref"] = "GoogleCloudRetailV2ExperimentInfo",
          },
          type = "array",
        },
        facets = {
    ...
    GoogleCloudRetailV2ServingConfig = {
      ...
      properties = {
        ...
        ignoreRecsDenylist = {
          description = "When the flag is enabled, the products in the denylist will not be filtered out in the recommendation filtering results.",
          type = "boolean",
        },
        modelId = {
    ...
    GoogleCloudRetailV2UserEvent = {
      ...
      properties = {
        ...
        entity = {
          description = "The entity for customers that may run multiple different entities, domains, sites or regions, for example, `Google US`, `Google Ads`, `Waymo`, `google.com`, `youtube.com`, etc. We recommend that you set this field to get better per-entity search, completion, and prediction results.",
          type = "string",
        },
        eventTime = {
    ...
    GoogleCloudRetailV2alphaCreateMerchantCenterAccountLinkMetadata = {
      ...
      id = "GoogleCloudRetailV2alphaCreateMerchantCenterAccountLinkMetadata",
      properties = {
        createTime = {
          description = "Operation create time.",
          format = "google-datetime",
    ...
    GoogleCloudRetailV2alphaExportAnalyticsMetricsResponse = {
      description = "Response of the ExportAnalyticsMetricsRequest. If the long running operation was successful, then this message is returned by the google.longrunning.Operations.response field if the operation was successful.",
      id = "GoogleCloudRetailV2alphaExportAnalyticsMetricsResponse",
      properties = {
        errorSamples = {
          description = "A sample of errors encountered while processing the request.",
          items = {
    ...
    GoogleCloudRetailV2alphaMerchantCenterAccountLink = {
      ...
      id = "GoogleCloudRetailV2alphaMerchantCenterAccountLink",
      properties = {
        branchId = {
        ...
        feedFilters = {
          ...
          items = {
            ["$ref"] = "GoogleCloudRetailV2alphaMerchantCenterAccountLinkMerchantCenterFeedFilter",
          },
          type = "array",
        },
        feedLabel = {
    ...
    GoogleCloudRetailV2alphaModel = {
      ...
      properties = {
        ...
        modelFeaturesConfig = {
          ["$ref"] = "GoogleCloudRetailV2alphaModelModelFeaturesConfig",
          description = "Optional. Additional model features config.",
        },
        name = {
          description = "Required. The fully qualified resource name of the model. Format: `projects/{project_number}/locations/{location_id}/catalogs/{catalog_id}/models/{model_id}` catalog_id has char limit of 50. recommendation_model_id has char limit of 40.",
    ...
    GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig = {
      description = "Additional configs for the frequently-bought-together model type.",
      id = "GoogleCloudRetailV2alphaModelFrequentlyBoughtTogetherFeaturesConfig",
      properties = {
        contextProductsType = {
          description = "Optional. Specifies the context of the model when it is used in predict requests. Can only be set for the `frequently-bought-together` type. If it isn't specified, it defaults to MULTIPLE_CONTEXT_PRODUCTS.",
          enum = {
    ...
    GoogleCloudRetailV2alphaModelModelFeaturesConfig = {
      description = "Additional model features config.",
      id = "GoogleCloudRetailV2alphaModelModelFeaturesConfig",
      properties = {
        frequentlyBoughtTogetherConfig = {
    ...
    GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig = {
      description = "Additional configs for the frequently-bought-together model type.",
      id = "GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig",
      properties = {
        contextProductsType = {
          description = "Optional. Specifies the context of the model when it is used in predict requests. Can only be set for the `frequently-bought-together` type. If it isn't specified, it defaults to MULTIPLE_CONTEXT_PRODUCTS.",
          enum = {
    ...
    GoogleCloudRetailV2betaModelModelFeaturesConfig = {
      description = "Additional model features config.",
      id = "GoogleCloudRetailV2betaModelModelFeaturesConfig",
      properties = {
        frequentlyBoughtTogetherConfig = {
          ["$ref"] = "GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig",
          description = "Additional configs for frequently-bought-together models.",
        },
      },
      type = "object",
