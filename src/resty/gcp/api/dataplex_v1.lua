return {
  ...
  schemas = {
    ...
    GoogleCloudDataplexV1Aspect = {
      ...
      properties = {
        ...
        data = {
          ...
          description = "Required. The content of the aspect, according to its aspect type schema. This will replace content. The maximum size of the field is 120KB (encoded as UTF-8).",
          type = "object",
        },
        path = {
    ...
    GoogleCloudDataplexV1AspectSource = {
      description = "AspectSource contains source system related information for the aspect.",
    ...
    GoogleCloudDataplexV1AspectType = {
      description = "Aspect Type is a template for creating Aspects, and represents the JSON-schema for a given Entry, e.g., BigQuery Table Schema.",
      ...
      properties = {
        ...
        uid = {
          description = "Output only. System generated globally unique ID for the AspectType. This ID will be different if the AspectType is deleted and re-created with the same name.",
          readOnly = true,
          type = "string",
        },
        updateTime = {
    ...
    GoogleCloudDataplexV1AspectTypeAuthorization = {
      description = "Autorization for an Aspect Type.",
      id = "GoogleCloudDataplexV1AspectTypeAuthorization",
      properties = {
        alternateUsePermission = {
          description = "Immutable. The IAM permission grantable on the Entry Group to allow access to instantiate Aspects of Dataplex owned Aspect Types, only settable for Dataplex owned Types.",
          type = "string",
        },
      },
      type = "object",
    ...
    GoogleCloudDataplexV1AspectTypeMetadataTemplate = {
      description = "MetadataTemplate definition for AspectType",
      ...
      properties = {
        ...
        enumValues = {
          description = "Optional. The list of values for an enum type. Needs to be defined if the type is enum.",
          items = {
        ...
        recordFields = {
          description = "Optional. Field definition, needs to be specified if the type is record. Defines the nested fields.",
          items = {
            ["$ref"] = "GoogleCloudDataplexV1AspectTypeMetadataTemplate",
          },
          type = "array",
        ...
        type = {
          description = "Required. The datatype of this field. The following values are supported: Primitive types (string, integer, boolean, double, datetime); datetime must be of the format RFC3339 UTC \"Zulu\" (Examples: \"2014-10-02T15:01:23Z\" and \"2014-10-02T15:01:23.045123456Z\"). Complex types (enum, array, map, record).",
          type = "string",
        },
        typeId = {
          description = "Optional. Id can be used if this definition of the field needs to be reused later. Id needs to be unique across the entire template. Id can only be specified if the field type is record.",
          type = "string",
        },
        typeRef = {
          description = "Optional. A reference to another field definition (instead of an inline definition). The value must be equal to the value of an id field defined elsewhere in the MetadataTemplate. Only fields with type as record can refer to other fields.",
          type = "string",
        },
      },
      type = "object",
    ...
    GoogleCloudDataplexV1AspectTypeMetadataTemplateAnnotations = {
      ...
      properties = {
        deprecated = {
          description = "Optional. Marks a field as deprecated, a deprecation message can be included.",
          type = "string",
        },
        description = {
        ...
        displayName = {
          description = "Optional. Specify a displayname for a field.",
          type = "string",
        },
        displayOrder = {
          description = "Optional. Specify a display order for a field. Display order can be used to reorder where a field is rendered",
          format = "int32",
          type = "integer",
        },
        stringType = {
          description = "Optional. String Type annotations can be used to specify special meaning to string fields. The following values are supported: richText: The field must be interpreted as a rich text field. url: A fully qualified url link. resource: A service qualified resource reference.",
          type = "string",
        },
        stringValues = {
          description = "Optional. Suggested hints for string fields. These can be used to suggest values to users, through an UI for example.",
          items = {
            type = "string",
          },
          type = "array",
    ...
    GoogleCloudDataplexV1AspectTypeMetadataTemplateConstraints = {
      ...
      properties = {
        required = {
          description = "Optional. Marks this as an optional/required field.",
          type = "boolean",
        },
      },
      type = "object",
    ...
    GoogleCloudDataplexV1AspectTypeMetadataTemplateEnumValue = {
      description = "Definition of Enumvalue (to be used by enum fields)",
      id = "GoogleCloudDataplexV1AspectTypeMetadataTemplateEnumValue",
      properties = {
        deprecated = {
          description = "Optional. Optional deprecation message to be set if an enum value needs to be deprecated.",
          type = "string",
        },
        index = {
          description = "Required. Index for the enum. Cannot be modified.",
          format = "int32",
          type = "integer",
        },
        name = {
          description = "Required. Name of the enumvalue. This is the actual value that the aspect will contain.",
          type = "string",
        },
      },
      type = "object",
    ...
    GoogleCloudDataplexV1Entry = {
      ...
      properties = {
        ...
        entrySource = {
          ...
          description = "Optional. Source system related information for an entry.",
        },
        entryType = {
    ...
    GoogleCloudDataplexV1EntryGroup = {
      ...
      properties = {
        ...
        uid = {
          description = "Output only. System generated globally unique ID for the EntryGroup. This ID will be different if the EntryGroup is deleted and re-created with the same name.",
          readOnly = true,
          type = "string",
        },
        updateTime = {
    ...
    GoogleCloudDataplexV1EntrySource = {
      description = "EntrySource contains source system related information for the entry.",
    ...
    GoogleCloudDataplexV1ListAspectTypesResponse = {
      ...
      properties = {
        aspectTypes = {
          description = "ListAspectTypes under the given parent location.",
          items = {
            ["$ref"] = "GoogleCloudDataplexV1AspectType",
          },
          type = "array",
    ...
    GoogleCloudDataplexV1ListEntryGroupsResponse = {
      ...
      properties = {
        entryGroups = {
          description = "ListEntryGroups under the given parent location.",
          items = {
            ["$ref"] = "GoogleCloudDataplexV1EntryGroup",
          },
          type = "array",
    ...
    GoogleCloudDataplexV1ListEntryTypesResponse = {
      ...
      properties = {
        entryTypes = {
          description = "ListEntryTypes under the given parent location.",
          items = {
            ["$ref"] = "GoogleCloudDataplexV1EntryType",
          },
          type = "array",
    ...
    GoogleCloudDataplexV1SearchEntriesResponse = {
      ...
      properties = {
        ...
        totalSize = {
          description = "The estimated total number of matching entries. Not guaranteed to be accurate.",
          format = "int32",
          type = "integer",
        },
        unreachable = {
          description = "Unreachable locations. Search results don't include data from those locations.",
          items = {
            type = "string",
          },
          type = "array",
