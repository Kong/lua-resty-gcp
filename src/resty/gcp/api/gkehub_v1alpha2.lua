return {
  ...
  ["schemas"] = {
    ...
    ["InitializeHubResponse"] = {
      ...
      ["properties"] = {
        ["serviceIdentity"] = {
          ["description"] = "Name of the Hub default service identity, in the format: service-@gcp-sa-gkehub.iam.gserviceaccount.com The service account has `roles/gkehub.serviceAgent` in the Hub project.",
          ["type"] = "string",
        },
        ["workloadIdentityPool"] = {
          ["description"] = "The Workload Identity Pool used for Workload Identity-enabled clusters registered with this Hub. Format: `.hub.id.goog`",
          ["type"] = "string",
        },
      },
      ["type"] = "object",
