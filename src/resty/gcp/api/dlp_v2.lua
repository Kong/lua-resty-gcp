return {
  ...
  ["schemas"] = {
    ...
    ["GooglePrivacyDlpV2DataProfilePubSubCondition"] = {
      ["description"] = "A condition for determining whether a PubSub should be triggered.",
    ...
    ["GooglePrivacyDlpV2DataProfilePubSubMessage"] = {
      ["description"] = "Pub/Sub topic message for a DataProfileAction.PubSubNotification event. To receive a message of protocol buffer schema type, convert the message data to an object of this proto class. https://cloud.google.com/pubsub/docs/samples/pubsub-subscribe-proto-messages",
    ...
    ["GooglePrivacyDlpV2TableDataProfile"] = {
      ...
      ["properties"] = {
        ...
        ["rowCount"] = {
          ["description"] = "Number of rows in the table when the profile was generated.",
          ["format"] = "int64",
          ["type"] = "string",
        },
        ["scannedColumnCount"] = {
