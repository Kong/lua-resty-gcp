  ...
  ["schemas"] = {
    ...
    ["CloudSqlProperties"] = {
      ...
      ["properties"] = {
        ...
        ["serviceAccountId"] = {
          ["description"] = "Output only. The account ID of the service used for the purpose of this connection. When the connection is used in the context of an operation in BigQuery, this service account will serve as identity being used for connecting to the CloudSQL instance specified in this connection.",
          ["readOnly"] = true,
          ["type"] = "string",
        },
        ["type"] = {
