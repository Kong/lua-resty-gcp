...
mv lua-resty-gcp-0.0.4-1.rockspec lua-resty-gcp-0.0.4-1.rockspec.original

cp lua-resty-gcp-0.0.4-1.rockspec lua-resty-gcp-0.0.4-1.rockspec

echo $ROCKSPEC_ADD

# For non mac
# sed -i 's#--AUTOGEN--#'$ROCKSPEC_ADD'#g' lua-resty-gcp-0.0.4-1.rockspec
