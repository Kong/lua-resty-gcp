  ...
  schemas = {
    ...
    GoogleCloudDiscoveryengineV1BigtableSource = {
      ...
      properties = {
        ...
        projectId = {
          description = "The project ID that the Bigtable source is in with a length limit of 128 characters. If not specified, inherits the project ID from the parent request.",
          type = "string",
        },
        tableId = {
    ...
    GoogleCloudDiscoveryengineV1FirestoreSource = {
      ...
      properties = {
        collectionId = {
          description = "Required. The Firestore collection to copy the data from with a length limit of 1,500 characters.",
          type = "string",
        },
        databaseId = {
    ...
    GoogleCloudDiscoveryengineV1SpannerSource = {
      ...
      properties = {
        ...
        projectId = {
          description = "The project ID that the Spanner source is in with a length limit of 128 characters. If not specified, inherits the project ID from the parent request.",
          type = "string",
        },
        tableId = {
    ...
    GoogleCloudDiscoveryengineV1alphaAnswerCitation = {
      ...
      properties = {
        ...
        startIndex = {
          description = "Index indicates the start of the segment, measured in bytes (UTF-8 unicode).",
          format = "int64",
          type = "string",
        },
      },
    ...
    GoogleCloudDiscoveryengineV1alphaProject = {
      ...
      properties = {
        ...
        name = {
          description = "Output only. Full resource name of the project, for example `projects/{project_number}`. Note that when making requests, project number and project id are both acceptable, but the server will always respond in project number.",
          readOnly = true,
          type = "string",
        },
    ...
    GoogleCloudDiscoveryengineV1alphaSessionTurn = {
      ...
      properties = {
        answer = {
          description = "The resource name of the answer to the user query.",
          type = "string",
        },
        query = {
