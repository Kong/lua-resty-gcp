      ...
      ["properties"] = {
        ["onClose"] = {
          ...
          ["enumDescriptions"] = {
            ...
            "Reloads the card after the child window closes. If used in conjunction with [OpenAs.OVERLAY](/workspace/add-ons/reference/rpc/google.apps.card.v1#openas), the child window acts as a modal dialog and the main card is blocked until the child window closes.",
          },
          ["type"] = "string",
        },
        ["openAs"] = {
