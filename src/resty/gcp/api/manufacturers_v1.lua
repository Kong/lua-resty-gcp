  ...
  ["schemas"] = {
    ["Attributes"] = {
      ...
      ["properties"] = {
        ...
        ["grocery"] = {
          ["$ref"] = "Grocery",
          ["description"] = "Grocery Attributes. For more information, see go/mfc-nutrition-attributes.",
        },
        ["gtin"] = {
        ...
        ["nutrition"] = {
          ["$ref"] = "Nutrition",
          ["description"] = "Nutrition Attributes. For more information, see go/mfc-nutrition-attributes.",
        },
        ["pattern"] = {
    ...
    ["FloatUnit"] = {
      ["description"] = "Combination of float amout and unit.",
      ["id"] = "FloatUnit",
      ["properties"] = {
        ["amount"] = {
          ["description"] = "amount.",
