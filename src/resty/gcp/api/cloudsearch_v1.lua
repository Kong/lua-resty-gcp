return {
  ...
  ["schemas"] = {
    ...
    ["AppsDynamiteAnnotation"] = {
      ...
      ["id"] = "AppsDynamiteAnnotation",
      ["properties"] = {
        ["babelPlaceholderMetadata"] = {
          ["$ref"] = "AppsDynamiteBabelPlaceholderMetadata",
        },
        ["cardCapabilityMetadata"] = {
          ["$ref"] = "AppsDynamiteCardCapabilityMetadata",
        ...
        ["consentedAppUnfurlMetadata"] = {
          ["$ref"] = "AppsDynamiteConsentedAppUnfurlMetadata",
        },
        ["customEmojiMetadata"] = {
          ["$ref"] = "AppsDynamiteCustomEmojiMetadata",
        },
        ["dataLossPreventionMetadata"] = {
          ["$ref"] = "AppsDynamiteDataLossPreventionMetadata",
        },
        ["driveMetadata"] = {
          ["$ref"] = "AppsDynamiteDriveMetadata",
          ["description"] = "Chip annotations",
        },
        ["formatMetadata"] = {
          ["$ref"] = "AppsDynamiteFormatMetadata",
        },
        ["groupRetentionSettingsUpdated"] = {
          ["$ref"] = "AppsDynamiteGroupRetentionSettingsUpdatedMetaData",
        },
        ["gsuiteIntegrationMetadata"] = {
          ["$ref"] = "AppsDynamiteGsuiteIntegrationMetadata",
        ...
        ["incomingWebhookChangedMetadata"] = {
          ["$ref"] = "AppsDynamiteIncomingWebhookChangedMetadata",
        },
        ["integrationConfigUpdated"] = {
          ["$ref"] = "AppsDynamiteIntegrationConfigUpdatedMetadata",
          ["description"] = "LINT.ThenChange(//depot/google3/java/com/google/apps/dynamite/v1/backend/action/common/SystemMessageHelper.java)",
        },
        ["length"] = {
        ...
        ["roomUpdated"] = {
          ["$ref"] = "AppsDynamiteRoomUpdatedMetadata",
        },
        ["serverInvalidated"] = {
        ...
        ["slashCommandMetadata"] = {
          ["$ref"] = "AppsDynamiteSlashCommandMetadata",
        },
        ["startIndex"] = {
        ...
        ["uploadMetadata"] = {
          ["$ref"] = "AppsDynamiteUploadMetadata",
        },
        ["urlMetadata"] = {
          ["$ref"] = "AppsDynamiteUrlMetadata",
        },
        ["userMentionMetadata"] = {
          ["$ref"] = "AppsDynamiteUserMentionMetadata",
          ["description"] = "Metadata that clients can set for annotations. LINT.IfChange In-text annotations",
        },
        ["videoCallMetadata"] = {
          ["$ref"] = "AppsDynamiteVideoCallMetadata",
        },
        ["youtubeMetadata"] = {
          ["$ref"] = "AppsDynamiteYoutubeMetadata",
        },
      },
      ["type"] = "object",
    },
    ...
    ["AppsDynamiteBabelMessageProps"] = {
      ...
      ["id"] = "AppsDynamiteBabelMessageProps",
      ["properties"] = {
        ["clientGeneratedId"] = {
    ...
    ["AppsDynamiteBabelPlaceholderMetadata"] = {
      ...
      ["id"] = "AppsDynamiteBabelPlaceholderMetadata",
      ["properties"] = {
        ["deleteMetadata"] = {
          ["$ref"] = "AppsDynamiteBabelPlaceholderMetadataDeleteMetadata",
        },
        ["editMetadata"] = {
          ["$ref"] = "AppsDynamiteBabelPlaceholderMetadataEditMetadata",
        },
    ...
    ["AppsDynamiteBabelPlaceholderMetadataDeleteMetadata"] = {
    ...
    ["AppsDynamiteBabelPlaceholderMetadataEditMetadata"] = {
      ["description"] = "A message edit in Dynamite inserts a Babel-only item containing this field.",
      ["id"] = "AppsDynamiteBabelPlaceholderMetadataEditMetadata",
      ["properties"] = {},
      ["type"] = "object",
    },
    ["AppsDynamiteBabelPlaceholderMetadataHangoutVideoEventMetadata"] = {
      ["description"] = "A message representing the Hangout video start/end events in Babel",
      ["id"] = "AppsDynamiteBabelPlaceholderMetadataHangoutVideoEventMetadata",
      ["properties"] = {
        ["hangoutVideoType"] = {
          ["enum"] = {
    ...
    ["AppsDynamiteBackendDlpScanSummary"] = {
      ...
      ["id"] = "AppsDynamiteBackendDlpScanSummary",
      ["properties"] = {
        ["scanId"] = {
    ...
    ["AppsDynamiteBackendLabelsPersonalLabelTag"] = {
      ...
      ["id"] = "AppsDynamiteBackendLabelsPersonalLabelTag",
      ["properties"] = {
        ["labelId"] = {
    ...
    ["AppsDynamiteCardCapabilityMetadata"] = {
      ["id"] = "AppsDynamiteCardCapabilityMetadata",
      ["properties"] = {
    ...
    ["AppsDynamiteConsentedAppUnfurlMetadata"] = {
      ["description"] = "Annotation metadata app unfurl consent.",
      ["id"] = "AppsDynamiteConsentedAppUnfurlMetadata",
      ["properties"] = {
    ...
    ["AppsDynamiteContentReport"] = {
      ...
      ["properties"] = {
        ...
        ["reportJustification"] = {
          ["$ref"] = "AppsDynamiteContentReportJustification",
    ...
    ["AppsDynamiteContentReportJustification"] = {
      ["id"] = "AppsDynamiteContentReportJustification",
      ["properties"] = {
        ["userJustification"] = {
    ...
    ["AppsDynamiteCustomEmojiMetadata"] = {
      ["id"] = "AppsDynamiteCustomEmojiMetadata",
      ["properties"] = {
        ["customEmoji"] = {
    ...
    ["AppsDynamiteDataLossPreventionMetadata"] = {
      ...
      ["id"] = "AppsDynamiteDataLossPreventionMetadata",
      ["properties"] = {
        ["dlpScanSummary"] = {
          ["$ref"] = "AppsDynamiteBackendDlpScanSummary",
    ...
    ["AppsDynamiteDriveMetadata"] = {
      ["description"] = "Annotation metadata for Drive artifacts.",
      ["id"] = "AppsDynamiteDriveMetadata",
      ["properties"] = {
        ["aclFixRequest"] = {
          ["$ref"] = "AppsDynamiteDriveMetadataAclFixRequest",
        },
        ["aclFixStatus"] = {
          ["$ref"] = "AppsDynamiteDriveMetadataAclFixStatus",
        },
        ["canEdit"] = {
        ...
        ["legacyUploadMetadata"] = {
          ["$ref"] = "AppsDynamiteDriveMetadataLegacyUploadMetadata",
    ...
    ["AppsDynamiteDriveMetadataAclFixRequest"] = {
      ...
      ["id"] = "AppsDynamiteDriveMetadataAclFixRequest",
      ["properties"] = {
        ["recipientEmails"] = {
    ...
    ["AppsDynamiteDriveMetadataAclFixStatus"] = {
      ...
      ["id"] = "AppsDynamiteDriveMetadataAclFixStatus",
      ["properties"] = {
        ["fixability"] = {
          ["enum"] = {
            "UNKNOWN",
    ...
    ["AppsDynamiteDriveMetadataLegacyUploadMetadata"] = {
      ...
      ["id"] = "AppsDynamiteDriveMetadataLegacyUploadMetadata",
      ["properties"] = {
        ["legacyUniqueId"] = {
    ...
    ["AppsDynamiteFormatMetadata"] = {
      ["description"] = "Annotation metadata for markup formatting",
      ["id"] = "AppsDynamiteFormatMetadata",
      ["properties"] = {
        ["fontColor"] = {
    ...
    ["AppsDynamiteFrontendBotInfo"] = {
      ["description"] = "Bot-specific profile information.",
      ["id"] = "AppsDynamiteFrontendBotInfo",
      ["properties"] = {
        ["appId"] = {
          ["$ref"] = "AppsDynamiteAppId",
        ...
        ["supportUrls"] = {
          ["$ref"] = "AppsDynamiteFrontendBotInfoSupportUrls",
    ...
    ["AppsDynamiteFrontendBotInfoSupportUrls"] = {
      ["description"] = "Urls with additional bot related information.",
      ["id"] = "AppsDynamiteFrontendBotInfoSupportUrls",
      ["properties"] = {
        ["adminConfigUrl"] = {
    ...
    ["AppsDynamiteFrontendMember"] = {
      ["id"] = "AppsDynamiteFrontendMember",
      ["properties"] = {
        ["roster"] = {
          ["$ref"] = "AppsDynamiteFrontendRoster",
        },
        ["user"] = {
          ["$ref"] = "AppsDynamiteFrontendUser",
        },
      },
      ["type"] = "object",
    },
    ["AppsDynamiteFrontendRoster"] = {
      ["description"] = "Roster profile information.",
      ["id"] = "AppsDynamiteFrontendRoster",
      ["properties"] = {
        ["avatarUrl"] = {
          ["type"] = "string",
        },
        ["id"] = {
          ["$ref"] = "AppsDynamiteRosterId",
        },
        ["membershipCount"] = {
          ["format"] = "int32",
          ["type"] = "integer",
    ...
    ["AppsDynamiteFrontendUser"] = {
      ...
      ["properties"] = {
        ...
        ["botInfo"] = {
          ["$ref"] = "AppsDynamiteFrontendBotInfo",
    ...
    ["AppsDynamiteGroupId"] = {
      ...
      ["id"] = "AppsDynamiteGroupId",
      ["properties"] = {
        ["dmId"] = {
          ["$ref"] = "AppsDynamiteDmId",
          ["description"] = "Unique, immutable ID of the Direct Message Space",
        },
        ["spaceId"] = {
          ["$ref"] = "AppsDynamiteSpaceId",
          ["description"] = "Unique, immutable ID of the Space",
        },
      },
      ["type"] = "object",
    },
    ["AppsDynamiteGroupRetentionSettingsUpdatedMetaData"] = {
      ["id"] = "AppsDynamiteGroupRetentionSettingsUpdatedMetaData",
      ["properties"] = {
        ["initiator"] = {
          ["$ref"] = "AppsDynamiteUserId",
    ...
    ["AppsDynamiteGsuiteIntegrationMetadata"] = {
      ["description"] = "Annotation metadata for an GsuiteIntegration artifact.",
      ["id"] = "AppsDynamiteGsuiteIntegrationMetadata",
      ["properties"] = {
        ["activityFeedData"] = {
    ...
    ["AppsDynamiteIncomingWebhookChangedMetadata"] = {
      ...
      ["id"] = "AppsDynamiteIncomingWebhookChangedMetadata",
      ["properties"] = {
        ["incomingWebhookName"] = {
    ...
    ["AppsDynamiteIntegrationConfigMutation"] = {
      ["id"] = "AppsDynamiteIntegrationConfigMutation",
      ["properties"] = {
        ["addApp"] = {
          ["$ref"] = "AppsDynamiteAppId",
    ...
    ["AppsDynamiteIntegrationConfigUpdatedMetadata"] = {
      ...
      ["id"] = "AppsDynamiteIntegrationConfigUpdatedMetadata",
      ["properties"] = {
        ["initiatorId"] = {
          ["$ref"] = "AppsDynamiteUserId",
        ...
        ["mutations"] = {
          ...
          ["items"] = {
            ["$ref"] = "AppsDynamiteIntegrationConfigMutation",
          },
          ["type"] = "array",
        },
      },
    ...
    ["AppsDynamiteMembershipChangedMetadata"] = {
      ...
      ["id"] = "AppsDynamiteMembershipChangedMetadata",
      ["properties"] = {
        ["affectedMemberProfiles"] = {
          ["items"] = {
            ["$ref"] = "AppsDynamiteFrontendMember",
          },
          ["type"] = "array",
        },
        ["affectedMembers"] = {
          ...
          ["items"] = {
            ["$ref"] = "AppsDynamiteMemberId",
          },
          ["type"] = "array",
        },
        ["affectedMemberships"] = {
          ["items"] = {
            ["$ref"] = "AppsDynamiteMembershipChangedMetadataAffectedMembership",
          },
          ["type"] = "array",
        },
        ["initiator"] = {
    ...
    ["AppsDynamiteMembershipChangedMetadataAffectedMembership"] = {
      ...
      ["id"] = "AppsDynamiteMembershipChangedMetadataAffectedMembership",
      ["properties"] = {
        ["affectedMember"] = {
          ["$ref"] = "AppsDynamiteMemberId",
        },
    ...
    ["AppsDynamiteMessage"] = {
      ...
      ["properties"] = {
        ...
        ["attachments"] = {
          ...
          ["items"] = {
            ["$ref"] = "AppsDynamiteAttachment",
          },
          ["type"] = "array",
        },
        ["attributes"] = {
          ["$ref"] = "AppsDynamiteMessageAttributes",
        ...
        ["communalLabels"] = {
          ...
          ["items"] = {
            ["$ref"] = "AppsDynamiteBackendLabelsCommunalLabelTag",
          },
          ["type"] = "array",
        },
        ["contentReportSummary"] = {
          ["$ref"] = "AppsDynamiteMessageContentReportSummary",
          ["readOnly"] = true,
        },
        ["createTime"] = {
        ...
        ["personalLabels"] = {
          ...
          ["items"] = {
            ["$ref"] = "AppsDynamiteBackendLabelsPersonalLabelTag",
          },
          ["type"] = "array",
        },
        ["privateMessageInfos"] = {
          ...
          ["items"] = {
            ["$ref"] = "AppsDynamitePrivateMessageInfo",
          },
          ["type"] = "array",
        },
        ...
        ["quotedMessageMetadata"] = {
          ["$ref"] = "AppsDynamiteQuotedMessageMetadata",
        ...
        ["tombstoneMetadata"] = {
          ["$ref"] = "AppsDynamiteTombstoneMetadata",
    ...
    ["AppsDynamiteMessageContentReportSummary"] = {
      ...
      ["id"] = "AppsDynamiteMessageContentReportSummary",
      ["properties"] = {
        ["numberReports"] = {
    ...
    ["AppsDynamiteMessageId"] = {
      ...
      ["properties"] = {
        ...
        ["parentId"] = {
          ["$ref"] = "AppsDynamiteMessageParentId",
          ["description"] = "ID of the Message's immediate parent.",
        },
      },
      ["type"] = "object",
    },
    ["AppsDynamiteMessageInfo"] = {
      ["id"] = "AppsDynamiteMessageInfo",
      ["properties"] = {
        ["message"] = {
          ["$ref"] = "AppsDynamiteMessage",
    ...
    ["AppsDynamiteMessageParentId"] = {
      ...
      ["id"] = "AppsDynamiteMessageParentId",
      ["properties"] = {
        ["topicId"] = {
          ["$ref"] = "AppsDynamiteTopicId",
          ["description"] = "ID of the Topic this Message is posted to. NEXT TAG : 5",
        },
      },
      ["type"] = "object",
    },
    ["AppsDynamiteMessageProps"] = {
      ...
      ["id"] = "AppsDynamiteMessageProps",
      ["properties"] = {
        ["babelProps"] = {
          ["$ref"] = "AppsDynamiteBabelMessageProps",
        },
      },
      ["type"] = "object",
    },
    ["AppsDynamitePinnedItemId"] = {
      ["id"] = "AppsDynamitePinnedItemId",
      ["properties"] = {
        ["driveId"] = {
    ...
    ["AppsDynamiteQuotedMessageMetadata"] = {
      ...
      ["id"] = "AppsDynamiteQuotedMessageMetadata",
      ["properties"] = {
        ["annotations"] = {
    ...
    ["AppsDynamiteReadReceiptsSettingsUpdatedMetadata"] = {
      ["id"] = "AppsDynamiteReadReceiptsSettingsUpdatedMetadata",
      ["properties"] = {
        ["readReceiptsEnabled"] = {
    ...
    ["AppsDynamiteRequiredMessageFeaturesMetadata"] = {
      ["description"] = "A list of capabilities that are used in this message.",
      ["id"] = "AppsDynamiteRequiredMessageFeaturesMetadata",
      ["properties"] = {
        ["requiredFeatures"] = {
          ["items"] = {
            ["enum"] = {
    ...
    ["AppsDynamiteRoomUpdatedMetadata"] = {
      ["id"] = "AppsDynamiteRoomUpdatedMetadata",
      ["properties"] = {
        ["groupDetailsMetadata"] = {
          ["$ref"] = "AppsDynamiteRoomUpdatedMetadataGroupDetailsUpdatedMetadata",
        },
        ...
        ["renameMetadata"] = {
          ["$ref"] = "AppsDynamiteRoomUpdatedMetadataRoomRenameMetadata",
        },
        ["visibility"] = {
    ...
    ["AppsDynamiteRoomUpdatedMetadataGroupDetailsUpdatedMetadata"] = {
      ["id"] = "AppsDynamiteRoomUpdatedMetadataGroupDetailsUpdatedMetadata",
      ["properties"] = {
        ["newGroupDetails"] = {
    ...
    ["AppsDynamiteRoomUpdatedMetadataRoomRenameMetadata"] = {
      ["id"] = "AppsDynamiteRoomUpdatedMetadataRoomRenameMetadata",
      ["properties"] = {
        ["newName"] = {
          ["type"] = "string",
        },
    ...
    ["AppsDynamiteSharedMessageInfo"] = {
      ["description"] = "Information that references a Dynamite chat message.",
    ...
    ["AppsDynamiteSlashCommandMetadata"] = {
      ["description"] = "Annotation metadata for slash commands (/).",
      ["id"] = "AppsDynamiteSlashCommandMetadata",
      ["properties"] = {
        ["argumentsHint"] = {
    ...
    ["AppsDynamiteTombstoneMetadata"] = {
      ...
      ["id"] = "AppsDynamiteTombstoneMetadata",
      ["properties"] = {
        ["tombstoneType"] = {
    ...
    ["AppsDynamiteUserMentionMetadata"] = {
      ["description"] = "Annotation metadata for user mentions (+/@/-).",
      ["id"] = "AppsDynamiteUserMentionMetadata",
      ["properties"] = {
        ["displayName"] = {
    ...
    ["AppsDynamiteVideoCallMetadata"] = {
      ["id"] = "AppsDynamiteVideoCallMetadata",
      ["properties"] = {
        ["meetingSpace"] = {
          ["$ref"] = "MeetingSpace",
    ...
    ["AppsDynamiteYoutubeMetadata"] = {
      ["description"] = "Annotation metadata for YouTube artifact.",
      ["id"] = "AppsDynamiteYoutubeMetadata",
      ["properties"] = {
        ["id"] = {
    ...
    ["CallSettings"] = {
      ...
      ["properties"] = {
        ...
        ["moderationEnabled"] = {
          ["description"] = "Indicates whether the current call is moderated. go/meet-multimod-dd",
          ["type"] = "boolean",
        },
        ["presentLock"] = {
    ...
    ["ChatContentExtension"] = {
      ...
      ["properties"] = {
        ...
        ["dynamitePlaceholderMetadata"] = {
          ["$ref"] = "DynamitePlaceholderMetadata",
    ...
    ["DynamitePlaceholderMetadata"] = {
      ...
      ["id"] = "DynamitePlaceholderMetadata",
      ["properties"] = {
        ["attachmentMetadata"] = {
          ["$ref"] = "AttachmentMetadata",
        },
        ["botMessageMetadata"] = {
          ["$ref"] = "BotMessageMetadata",
        },
        ["calendarEventMetadata"] = {
          ["$ref"] = "CalendarEventMetadata",
        },
        ["deleteMetadata"] = {
          ["$ref"] = "DeleteMetadata",
        },
    ...
    ["MeetingSpace"] = {
      ...
      ["properties"] = {
        ...
        ["meetingAlias"] = {
          ["description"] = "An optional alias for the meeting space. The alias can in some cases be resolved to the meeting space, similar to the meeting code. The limitation is that the user needs to be in the same meeting domain as the meeting space. See go/thor-backend/meeting-alias for more details.",
          ["type"] = "string",
        },
        ["meetingCode"] = {
    ...
    ["Settings"] = {
      ...
      ["properties"] = {
        ...
        ["moderationEnabled"] = {
          ["description"] = "Indicates whether the meeting space is moderated. go/meet-multimod-dd",
          ["type"] = "boolean",
        },
        ["presentLock"] = {
    ...
    ["UserInfo"] = {
      ["description"] = "Contains info regarding the updater of an Activity Feed item. Next Id: 6",
      ["id"] = "UserInfo",
      ["properties"] = {
        ["updaterCountDisplayType"] = {
          ["description"] = "Describes how updater_count_to_show should be used.",
