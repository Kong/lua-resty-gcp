return {
  ...
  resources = {
    ...
    instances = {
      methods = {
        ...
        switchover = {
          description = "Switches over from the primary instance to the replica instance.",
  ...
  schemas = {
    ...
    DatabaseInstance = {
      ...
      properties = {
        ...
        replicationCluster = {
          ...
          description = "Optional. The pair of a primary instance and disaster recovery (DR) replica. A DR replica is a cross-region replica that you designate for failover in the event that the primary instance has regional failure.",
        },
        rootPassword = {
    ...
    GeminiInstanceConfig = {
      ...
      properties = {
        activeQueryEnabled = {
          description = "Output only. Whether active query is enabled.",
          readOnly = true,
          type = "boolean",
        },
        entitled = {
        ...
        flagRecommenderEnabled = {
          description = "Output only. Whether flag recommender is enabled.",
          readOnly = true,
          type = "boolean",
        },
        googleVacuumMgmtEnabled = {
          description = "Output only. Whether vacuum management is enabled.",
          readOnly = true,
          type = "boolean",
        },
        indexAdvisorEnabled = {
          description = "Output only. Whether index advisor is enabled.",
          readOnly = true,
          type = "boolean",
        },
        oomSessionCancelEnabled = {
          description = "Output only. Whether oom session cancel is enabled.",
          readOnly = true,
          type = "boolean",
        },
      },
    ...
    ReplicationCluster = {
      description = "Primary-DR replica pair",
      id = "ReplicationCluster",
      properties = {
        drReplica = {
          description = "Output only. read-only field that indicates if the replica is a dr_replica; not set for a primary.",
          readOnly = true,
          type = "boolean",
        },
    ...
    SqlInstancesStartExternalSyncRequest = {
      ...
      properties = {
        migrationType = {
          description = "Optional. MigrationType decides if the migration is a physical file based migration or logical migration.",
          enum = {
