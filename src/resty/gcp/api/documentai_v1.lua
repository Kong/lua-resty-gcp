  ...
  ["schemas"] = {
    ...
    ["GoogleCloudDocumentaiV1BatchProcessMetadataIndividualProcessStatus"] = {
      ...
      ["properties"] = {
        ...
        ["status"] = {
          ["$ref"] = "GoogleRpcStatus",
          ["description"] = "The error encountered while attempting to process the document. Empty if there are no errors.",
        },
      },
      ["type"] = "object",
    },
    ...
    ["GoogleCloudDocumentaiV1Document"] = {
      ...
      ["properties"] = {
        ...
        ["textStyles"] = {
          ["description"] = "Placeholder. Styles for the Document.text.",
          ["items"] = {
    ...
    ["GoogleCloudDocumentaiV1ProcessRequest"] = {
      ...
      ["properties"] = {
        ["fieldMask"] = {
          ["description"] = "Specifies which fields to include in ProcessResponse's document.",
